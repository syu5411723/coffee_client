...
const components = {
  ...
  TemplatesSample: () => import('../../components/templates/Sample.vue' /* webpackChunkName: "components/templates-sample" */).then(c => wrapFunctional(c.default || c)),
  ...
  AtomsFooter: () => import('../../components/atoms/footer/index.js' /* webpackChunkName: "components/atoms-footer" */).then(c => wrapFunctional(c.default || c)),
  ...
  MoleculesMainSec02Sample02: () => import('../../components/molecules/main/sec02/Sample02.vue' /* webpackChunkName: "components/molecules-main-sec02-sample02" */).then(c => wrapFunctional(c.default || c)),
