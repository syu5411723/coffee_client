...
- `<TemplatesSample>` | `<templates-sample>` (components/templates/Sample.vue)
...
- `<AtomsFooter>` | `<atoms-footer>` (components/atoms/footer/index.js)
...
- `<MoleculesMainSec02Sample02>` | `<molecules-main-sec02-sample02>` (components/molecules/main/sec02/Sample02.vue)
