...
export { default as TemplatesSample } from '../../components/templates/Sample.vue'
...
export { default as AtomsFooter } from '../../components/atoms/footer/index.js'
...
export { default as MoleculesMainSec02Sample02 } from '../../components/molecules/main/sec02/Sample02.vue'
...
export const LazyTemplatesSample = import('../../components/templates/Sample.vue' /* webpackChunkName: "components/templates-sample" */).then(c => wrapFunctional(c.default || c))
...
export const LazyAtomsFooter = import('../../components/atoms/footer/index.js' /* webpackChunkName: "components/atoms-footer" */).then(c => wrapFunctional(c.default || c))
...
export const LazyMoleculesMainSec02Sample02 = import('../../components/molecules/main/sec02/Sample02.vue' /* webpackChunkName: "components/molecules-main-sec02-sample02" */).then(c => wrapFunctional(c.default || c))
